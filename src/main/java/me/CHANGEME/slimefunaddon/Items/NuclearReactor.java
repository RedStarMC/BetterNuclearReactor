...
public class NuclearReactor {
    static ItemStack[] recipe = {SlimefunItems.PROGRAMMABLE_ANDROID_BUTCHER,SlimefunItems.ENERGY_CONNECTOR,SlimefunItems.PROGRAMMABLE_ANDROID_BUTCHER,
                                  LeadCasing.BNR_lead_casing,SlimefunItems.NUCLEAR_REACTOR,LeadCasing.BNR_lead_casing,
                                  null,LeadCasing.BNR_lead_casing,null};
